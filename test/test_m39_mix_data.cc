...
{
    FILE *fp=fopen("/media/sujinglan/Files/mixed-sensor-data/m39/2018-11-25/181115093513.dat","rb") ;
    ...
    while (1) {
        ...
        if (flag==-2) break;
        if (flag==11) {
            if (get_m39_img("/media/sujinglan/Files/mixed-sensor-data/m39/2018-11-25",
